function [ok, pns_norm, pns_comp, t_axis]=calcPNS_C2(obj,hardware,doPlots)
...
hw.x.tau1        = asc.GradPatSup.Phys.PNS.flGSWDTauX(1);  % ms
hw.x.tau2        = asc.GradPatSup.Phys.PNS.flGSWDTauX(2);  % ms
hw.x.tau3        = asc.GradPatSup.Phys.PNS.flGSWDTauX(3);  % ms
hw.x.a1          = asc.GradPatSup.Phys.PNS.flGSWDAX(1);
hw.x.a2          = asc.GradPatSup.Phys.PNS.flGSWDAX(2);
hw.x.a3          = asc.GradPatSup.Phys.PNS.flGSWDAX(3);
hw.x.stim_limit  = asc.GradPatSup.Phys.PNS.flGSWDStimulationLimitX;  % T/m/s
hw.x.stim_thresh = asc.GradPatSup.Phys.PNS.flGSWDStimulationThresholdX;  % T/m/s
tmp = asc.asGPAParameters.sGCParameters;
hw.x.g_scale     = tmp.flGScaleFactorX;

hw.y.tau1        = asc.GradPatSup.Phys.PNS.flGSWDTauY(1);  % ms
hw.y.tau2        = asc.GradPatSup.Phys.PNS.flGSWDTauY(2);  % ms
hw.y.tau3        = asc.GradPatSup.Phys.PNS.flGSWDTauY(3);  % ms
hw.y.a1          = asc.GradPatSup.Phys.PNS.flGSWDAY(1);
hw.y.a2          = asc.GradPatSup.Phys.PNS.flGSWDAY(2);
hw.y.a3          = asc.GradPatSup.Phys.PNS.flGSWDAY(3);
hw.y.stim_limit  = asc.GradPatSup.Phys.PNS.flGSWDStimulationLimitY;  % T/m/s
hw.y.stim_thresh = asc.GradPatSup.Phys.PNS.flGSWDStimulationThresholdY;  % T/m/s
tmp = asc.asGPAParameters.sGCParameters;
hw.y.g_scale     = tmp.flGScaleFactorY;

hw.z.tau1        = asc.GradPatSup.Phys.PNS.flGSWDTauZ(1);  % ms
hw.z.tau2        = asc.GradPatSup.Phys.PNS.flGSWDTauZ(2);  % ms
hw.z.tau3        = asc.GradPatSup.Phys.PNS.flGSWDTauZ(3);  % ms
hw.z.a1          = asc.GradPatSup.Phys.PNS.flGSWDAZ(1);
hw.z.a2          = asc.GradPatSup.Phys.PNS.flGSWDAZ(2);
hw.z.a3          = asc.GradPatSup.Phys.PNS.flGSWDAZ(3);
hw.z.stim_limit  = asc.GradPatSup.Phys.PNS.flGSWDStimulationLimitZ;  % T/m/s
hw.z.stim_thresh = asc.GradPatSup.Phys.PNS.flGSWDStimulationThresholdZ;  % T/m/s
tmp = asc.asGPAParameters.sGCParameters;
hw.z.g_scale     = tmp.flGScaleFactorZ;
end
