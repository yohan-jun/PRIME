...
function create_header_parallel7T_180(g,b_est,gap,oversample)
...
for (ii = 1:8)
    ...
    % do grads
    fidx = fopen('gx180.float', 'wb');
    fidy = fopen('gy180.float', 'wb');
    fidz = fopen('gz180.float', 'wb');
