...
fidx = fopen('gx180_inv.float', 'wb');
fidy = fopen('gy180_inv.float', 'wb');
fidz = fopen('gz180_inv.float', 'wb');
...
fidrf_amp = fopen('rf_amp180_inv.float', 'wb');
fidrf_pha = fopen('rf_pha180_inv.float', 'wb');
