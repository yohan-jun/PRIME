...
[rf_90_set_wRefocus,g_90_versed_4us,AsymmetryFac_90,rf_180_versed,g_180_versed_4us,AsymmetryFac_180,slThick,nomFlips]=PulsePrep_v4(profile_filename,VerseDownFac);
%
% Length
...
slice_gap =70; % slice gap mm
ts_rf =  2*10^-6;  % rf dwelltime= 2us
amplscale = slThick/5;  % I want 5 mm slice thickness on scanner....
[rf_90_set_wRefocus_MB2, rf_180_versed_MB2,g_90_integral,g_180_integral] = generateMB2pulse_CLv1(rf_90_set_wRefocus,g_90_versed_4us,rf_180_versed,g_180_versed_4us,slice_gap,ts_rf,amplscale);
