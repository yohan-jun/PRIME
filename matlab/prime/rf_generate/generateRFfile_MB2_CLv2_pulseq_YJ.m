...
%%
% linear phase
profile_filename = 'gSliderRF_5x_exlinPhs_1p1mm_032624.mat';% load the gSlider5x 90 and 180 pulses
...
[rf_90_set_wRefocus,g_90_versed_4us,g_90_versed_rew_4us,...
    AsymmetryFac_90,rf_180_versed,g_180_versed_4us,AsymmetryFac_180,...
    slThick,nomFlips,...
    g_90_versed,g_180_versed]=PulsePrep_v4_pulseq_YJ(profile_filename,VerseDownFac);
%
...
slice_gap =23*5*220/200; % slice gap mm 70 mm (13*5) number of slices X gslider
ts_rf =  2*10^-6;  % rf dwelltime= 2us
% amplscale = slThick/5;  % I want 5 mm slice thickness on scanner....
amplscale = 1;  % I want 5 mm slice thickness on scanner....
[rf_90_set_wRefocus_MB2, rf_180_versed_MB2,g_90_integral,g_180_integral] = generateMB2pulse_CLv1_pulseq_YJ(rf_90_set_wRefocus,g_90_versed_4us,rf_180_versed,g_180_versed_4us,slice_gap,ts_rf,amplscale);
...
save('1p1mm/rf_MB1_1p1mm_032624_s26.mat','g_90_versed','g_180_versed');
save('1p1mm/rf_MB2_1p1mm_032624_s26.mat','g_90_versed_4us','g_90_versed_rew_4us',...
                                'g_180_versed_4us','rf_90_set_wRefocus_MB2','rf_180_versed_MB2');
