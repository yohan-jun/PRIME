function b = gSliderBeta_T90fac_YJ(N,G,Gind,tb,d1,d2,phi,T90fac)
...
if rem(G,2) && Gind == ceil(G/2) % centered sub-slice
    if G == 1 % no sub-slices, as a sanity check
        ...
        f = [0 (1/G-ftw)*(tb/2) (1/G+ftw)*(tb/2) (1*T90fac-ftw)*(tb/2) (1*T90fac+ftw)*(tb/2) (N/2)]/(N/2);
        m = [exp(1i*phi) exp(1i*phi) 1 1 0 0];
        w = [1 1 d1/d2];
        b = firls(N-1,f,real(m),w); % the third one
    end
else
...
%              shift-(1-ftw)*(tb/2) Gcent-(tb/G/2+ftw*(tb/2)) ...
%             Gcent-(tb/G/2-ftw*(tb/2)) Gcent+(tb/G/2-ftw*(tb/2)) ...
%             Gcent+(tb/G/2+ftw*(tb/2)) shift+(1-ftw)*(tb/2) ...
%             shift+(1+ftw)*(tb/2) (N/2)]/(N/2);
        f = [0 shift-(1*T90fac+ftw)*(tb/2) ...
             shift-(1*T90fac-ftw)*(tb/2) Gcent-(tb/G/2+ftw*(tb/2)) ...
            Gcent-(tb/G/2-ftw*(tb/2)) Gcent+(tb/G/2-ftw*(tb/2)) ...
            Gcent+(tb/G/2+ftw*(tb/2)) shift+(1*T90fac-ftw)*(tb/2) ...
            shift+(1*T90fac+ftw)*(tb/2) (N/2)]/(N/2);
...
%             shift+(1-ftw)*(tb/2) shift+(1+ftw)*(tb/2) (N/2)]/(N/2);
        f = [0 shift-(1*T90fac+ftw)*(tb/2) shift-(1*T90fac-ftw)*(tb/2) ...
            Gcent+(tb/G/2-ftw*(tb/2)) Gcent+(tb/G/2+ftw*(tb/2)) ...
            shift+(1*T90fac-ftw)*(tb/2) shift+(1*T90fac+ftw)*(tb/2) (N/2)]/(N/2);
...
%             shift+(1-ftw)*(tb/2) shift+(1+ftw)*(tb/2) (N/2)]/(N/2);
    ...
    b1 = firls(N-1,f,real(m),w); % the filter
    b2 = firls(N-1,f,real(m),w,'h');
